...
build: report-config lintfix bundle bundle_demo test coverage todo 
...
.PHONY: bundle_demo upddemo clean superclean prep prep-ci report-config publish lint lintfix test todo coverage report-coverage doc build gh-doc bundle
